...
/**
 * Api services for the `SysRole` model.
 */
@Injectable()
export class SysRoleApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `SysRole` object.)
   * </em>
   */
